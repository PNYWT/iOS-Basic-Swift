...
class ContentVC: UIViewController {
    ...
    private lazy var cltvHeaderTypeAppTbvView: CltvHeaderTypeAppView = {
        let view = CltvHeaderTypeAppView(uiModel: modelSetupView, perTabModel: perTabModel)
        view.backgroundColor = .clear
        return view
    }()
    
    private lazy var cltvHeaderTypeOtherTbvView: CltvHeaderTypeOtherView = {
        let view = CltvHeaderTypeOtherView(uiModel: modelSetupView, perTabModel: perTabModel)
        view.backgroundColor = .clear
        return view
    }()
...
//            cell.setupViewNativeAdmob(atIndex: indexPath)
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        view.pushNavigationToReadNews(
            sectionName: perTabModel.cat_name,
            modelNews: globalRequestNewsViewModel.dataSource.list_news[indexPath.item])
    }
}
